...
import com.boot.security.server.dto.AdMktBoxDto;
...
public interface AdMktBoxDao {
    ...
    List<AdMktBoxDto> list(@Param("params") Map<String, Object> params, @Param("offset") Integer offset, @Param("limit") Integer limit);
}
